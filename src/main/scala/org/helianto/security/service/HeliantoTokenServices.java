 ...
 */
public class HeliantoTokenServices implements AuthorizationServerTokenServices, ResourceServerTokenServices,
        ConsumerTokenServices, InitializingBean {

    private Logger logger = LoggerFactory.getLogger(HeliantoTokenServices.class);
    ...
    public OAuth2AccessToken refreshAccessToken(String refreshTokenValue, TokenRequest tokenRequest)
        ...
        logger.info("Authentication from refresh token: "+authentication);
        logger.info("Authentication client only: "+authentication.isClientOnly());
        ...
        if (this.authenticationManager != null && !authentication.isClientOnly()) {
            ...
            logger.info("Authentication details after re-authentication: "+details);
            authentication = new OAuth2Authentication(authentication.getOAuth2Request(), user);
            authentication.setDetails(details);
        }

        logger.info("New authentication after refresh token: "+authentication);
